...
public class Main {
    public static void main(String[] args) {
        ...
        jsonWriter.writeInJSONFile(metro.getMetroObject(), "D:/GIT/FilesAndNetwork/DataCollector/src/main/resources/metro.json");
        JSONReader jsonReader = new JSONReader();
        jsonReader.getAmountOfStations("D:/GIT/FilesAndNetwork/DataCollector/src/main/resources/metro.json");

        DataCollector collector = new DataCollector();
        collector.fileReader("D:/GIT/FilesAndNetwork/DataCollector/src/main/resources/data");
        ...
        jsonWriter1.writeInJSONFile(stationObject, "D:/GIT/FilesAndNetwork/DataCollector/src/main/resources/stations.json");
    }
